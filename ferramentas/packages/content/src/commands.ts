...
import { DEFAULT_LAYOUT, type Layout } from './schemas/layout.schema.js'
import { DEFAULT_BRANDING } from './schemas/branding.schema.js'
import type { Content } from './schemas/content.schema.js'
import type { Slide } from './schemas/slide.schema.js'
...
function withCarouselSlideUpdate(content: Content, slideIndex: number, updater: (slide: Slide) => Slide): Content {
